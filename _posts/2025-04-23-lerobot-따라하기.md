...
{% include website.html 
  ...
  image="https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/lerobot/hero.png" 
%}

LeRobot은 허깅페이스에서 로봇의 AI 연동 진입장벽을 낮추기 위해 2024년 5월 경 출시한 오픈소스 로봇 코드 라이브러리 입니다.

모방학습과 강화학습에 초점을 맞추고 있고, 사전 학습 모델과 시연데이터셋, 시뮬레이션 환경을 제공하는 올인원 라이브러리라고 할 수 있습니다.
...
{% include website.html 
  ...
  image="https://raw.githubusercontent.com/TheRobotStudio/SO-ARM100/master/docs/images/SO-ARM100_01.jpg" 
%}


사양을 보면 **STS3215 서보모터**를 사용하는데요. 12V 기준 국내 배송품은 약 4만원 대로 12개를 구매해야한다면 모터 값으로만 48만원을 사용해야합니다. 알리바바에서 STS3215모터는 2만원대로 구할 수 있기에 24만원이면 구할 수 있으나 알리바바로 직구하는 것은 도매상이 아니면 장벽이 있습니다. 3D 프린터가 있다면 
